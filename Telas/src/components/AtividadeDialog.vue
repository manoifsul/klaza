    ...
    <div class="box fit q-pa-md contentAula">
        ...
        <form @submit.prevent="save()">
            ...
            <div v-else class="column text-bold text-h4 q-gutter-y-md">
                ...
                <q-input outlined v-model="modelNome" label-color="white" input-class="text-white" label="Atividade" placeholder="Digite o nome da atividade"/>
                ...
                <q-input v-model="date" label-color="white" input-class="text-white" label="Dia" placeholder="Digite o dia da atividade" mask="##/##/####" fill-mask outlined>
                ...
                <q-input outlined input-class="text-white" label-color="white" placeholder="Digite o horario da atividade" label="Horario" v-model="time" mask="##:##" fill-mask :rules="['time']">
                    <template v-slot:append>
                ...
                <q-input outlined v-model="modelDescricao" label-color="white" input-class="text-white" label="Descrição" type="textarea" placeholder="Digite a descrição da atividade"/>
