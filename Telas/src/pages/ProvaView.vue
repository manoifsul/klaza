...
export default class ProvaView extends Vue {
    ...
    async created() {
        ...
        const provas = this.$store.state.provas as DBTypes.Prova[]
        ...
        const respostas = this.prova.resposta.filter(r => ( r.idAluno == this.idAluno && r.nroTentativa == this.nTentativa ))
