...
public class AlunoDto {
	...
	public AlunoDto(long idAluno, String nome, String matricula, String senha, String email, List<NotaTrabalho> notaTrabalho, List<NotaProva> notaProva, List<Long> idTurmas) {
