...
public class Trabalho {
	...
	public Trabalho(long idTrabalho, String nome, LocalDateTime prazo, String descricao, LocalDateTime inicio, long tempo, byte tentativas, byte tipo, List<Professor> professor,
